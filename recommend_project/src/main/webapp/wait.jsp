...
<script>
    function load() {
        window.location.href="/toRecommendPageTWO0"
    }
</script>
<title>请耐心等待</title>
<head>
                            ...
                            <div class="home-banner-section">
                                <div class="banner-div" style="padding-top: 140px;">
                                    <div class="banner-title-div"
                                        ...
                                        <div class="spinner-border text-primary mr-2" role="status" style="width: 100px;height:100px">
                                            <span class="sr-only">Loading...</span>
                                        </div>
                                        <a href="#">
                                            <p style="opacity: 1; transform: translate(0px, 0px);" class="">
                                                <strong>正在推荐最适合您的岗位，请耐心等待</strong></p>
                                        </a>
