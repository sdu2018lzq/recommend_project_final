...
">
    ...
    <div class="main">
        ...
        <main class="content" style="background-image: url(./directory2/img/page8/email-pattern.png);">
            ...
            <script src="/xiaoxizn-static//directory2/js/3.b2303953.chunk.js" type="text/javascript" async=""
                    ...
                    <div>
                            ...
                            <div class="home-banner-section">
                                <div class="banner-div" style="padding-top: 140px;">
                                    <div class="banner-title-div"
                                        ...
                                        <h1 style="opacity: 1; transform: translate(0px, 0px);" class="">用AI改变求职
                                        </h1><br>
                                        <p style="opacity: 1; transform: translate(0px, 0px);" class="">
                                            小飞智能服务于智能化人力资源行业。致力于通过AI技术提高求职速度，降低时间成本，节省求职支出。</p>
                                    </div>
                                </div>
                            </div>
                            <div class="home-outline-section">
                                <div class="outline-section">
                                    <div class="outline-div">
                                        <div class="outline-single">
                                            <!--                                            <div class="outline-single-title">-->
                                            <!--                                                <h4>提高求职速度</h4>-->
                                            <!--                                            </div>-->
                                            <div class="outline-single-number">
                                                <div class="outline-icon"><img
                                                        src="/directory2/img/page8/up.png";
                                                        alt="up-arrow"></div>
                                                <!--                                                <div>-->
                                                <!--                                                    <div style="width: min-content;">-->
                                                <!--                                                        <div-->
                                                <!--                                                                style="font-size: 96px; color: rgb(50, 50, 93); text-align: center; font-weight: 600;">-->
                                                <!--                                                            95</div>-->
                                                <!--                                                        -->
                                                <!--                                                    </div>-->
                                                <!--                                                </div>-->
                                                <div class="outline-span" style="font-size: 30px">提高求职速度</div>
                                            </div>
                                        </div>
                                        <div class="outline-single">
                                            <!--                                            <div class="outline-single-title">-->
                                            ...
                                            <div class="outline-single-number">
                                                <div class="outline-icon"><img
                                                        src="/directory2/img/page8/down.png"
                                                        alt="up-arrow"></div>
                                                <!--                                                <div>-->
                                                <!--                                                    <div style="width: min-content;">-->
                                                <!--                                                        <div-->
                                                ...
                                                <!--                                                    </div>-->
                                                <!--                                                </div>-->
                                                <div class="outline-span" style="font-size: 30px">降低时间成本</div>
                                            </div>
                                        </div>
                                        <div class="outline-single">
                                            <!--                                            <div class="outline-single-title">-->
                                            ...
                                            <div class="outline-single-number">
                                                ...
                                                <!--                                                    </div>-->
                                                <!--                                                </div>-->
                                                <div class="outline-span" style="font-size: 30px">节省求职支出</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div style="height: 100%;">
                            <div class="home-stack-section">
                                <div class="stack-section">
                                    <div class="intro">
                                        <h2>人工智能时代，用 <span>AI</span> 为求职赋能</h2>
                                    </div>
                                    <div class="stack-div">
                                        <div class="stack-single-div">
                                            <div class="stack-pic"><a class="stack-single-component"

                                                                      style="background-color: rgba(215, 130, 217, 0.2);"><img
                                                    src="/directory2/img/page8/portrait.svg"
                                                    height="40px" width="40px">
                                                <h4>简历分析</h4>
                                            </a><a class="stack-single-component"
                                                   style="background-color: rgba(255, 118, 0, 0.2);"><img
                                                    src="/directory2/img/page8/search.svg"
                                                    height="40px" width="40px">
                                                <h4>岗位搜索</h4>
                                            </a><a class="stack-single-component"
                                                   style="background-color: rgba(67, 211, 148, 0.2);"><img
                                                    src="/directory2/img/page8/recommender.svg"
                                                    height="40px" width="40px">
                                                <h4>行业分析</h4>
                                            </a><a class="stack-single-component"
                                                   style="background-color: rgba(167, 140, 233, 0.2);"><img
                                                    src="/directory2/img/page8/bot.svg" alt="bot"
                                                    height="40px" width="40px">
                                                <h4>岗位推荐</h4>
                                            </a></div>
                                            <div class="stack-desc">
                                                <h4>应用层面</h4>
                                                <p>我们提供简历分析，岗位搜索，行业分析，岗位推荐等应用，服务于求职AI。</p>
                                            </div>
                                        </div>
                                        <div class="stack-single-div">
                                            <div class="stack-pic"><a
                                                    class="stack-single-component stack-single-component-two"

                                                    style="background-color: rgba(103, 114, 229, 0.2);"><img
                                                    src="/directory2/img/page8/parser.svg"
                                                    height="40px" width="40px">
                                                <h4>简历解析</h4>
                                            </a><a class="stack-single-component stack-single-component-two"
                                                   style="background-color: rgba(31, 119, 224, 0.2);"><img
                                                    src="/directory2/img/page8/job.svg" alt="job"
                                                    height="40px" width="40px">
                                                <h4>职位解析</h4>
                                            </a></div>
                                            <div class="stack-desc">
                                                <h4>核心功能</h4>
                                                <p>我们的核心是简历解析和职位解析技术，为上层应用提供充分支持。</p>
                                            </div>
                                        </div>
                        ...
                        <div style="height: 100%;">
                            <div class="home-highlight-section">
                                <div class="highlight highlight-home">
                                    <div class="highlight-part">
                                        <div class="highlight-part-one-desc highlight-left">
                                            <!--                                            <h2>人工智能</h2>-->
                                            <h2><strong>人工智能</strong></h2>
                                            <p>利用人工智能技术，让计算机具备文字阅读能力，帮助客户自动化处理海量岗位数据。</p>
                                            <p>对岗位进行关键信息提取，匹配精准岗位，协助客户完成求职流程，提升工作效率。</p>
                                        </div>
                                        <div class="highlight-part-one-pic highlight-right">
                                            <div class="highlight-image">
                                                <div>
                                                    <div style="transform: translate(0px, 0px); opacity: 1;">
                                                        <img src="/directory2/img/page8/ai-min.png"
                                                             alt="ai"></div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="highlight-part">
                                        <div class="highlight-part-two-pic highlight-left">
                                            <div class="highlight-image">
                                                <div>
                                                    <div style="transform: translate(0px, 0px); opacity: 1;">
                                                        <img src="/directory2/img/page8/machine-learning-min.png"
                                                             alt="machine-learning"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="highlight-part-two-desc highlight-right">
                                            <!--                                            <h2>海量岗位挖掘</h2>-->
                                            <h2><strong>海量岗位挖掘</strong></h2>
                                            <p>基于数据挖掘技术，提取海量文本数据的潜在特征。</p>
                                            <p>对简历实时建模，构建结构化数据。</p>
                                            <p>对语句的重要内容实时抽取，快速理解文本内容，消除语义歧义。</p>
                                        </div>
                                    </div>
                                    <div class="highlight-part">
                                        <div class="highlight-part-three-desc highlight-left">
                                            <h2><strong>AI岗位推荐</strong></h2>
                                            <p>用神经网络技术自动挖掘数据的潜在规律，让算法拥有媲美求职者的准确寻找岗位能力。</p>
                                            <p>小飞智能的推荐系统时刻保持记忆化，拥有在大量岗位信息中快速准确推荐的能力。</p>
                                        </div>
                                        <div class="highlight-part-three-pic highlight-right">
                                            <div class="highlight-image">
                                                <div>
                                                    <div style="transform: translate(0px, 0px); opacity: 1;">
                                                        <img src="/directory2/img/page8/generalization-min.png"
                                                             alt="generalization"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
