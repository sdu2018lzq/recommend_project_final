...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <main class="content" style="background-image: url('img/loginBackground.jpg');background-size: 100% 100%;background-attachment: fixed">

            <div class="col-12 col-xl-6">
                <div class="card col-sm-8" style="float: right">
                    <div class="card-header">
                        <h1 class="card-title" style="font-size: x-large">注册账号</h1>
                    </div>
                    <div class="card-body">
                        <form method="post" id="toLogin" action="/toLogin">
                        </form>
                        <form method="post" action="/register">
                            <div class="form-group row">
                                <label class="col-form-label col-sm-3 text-sm-right">用&nbsp;&nbsp;户&nbsp;&nbsp;名</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label class="col-form-label col-sm-3 text-sm-right">电话号码</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="phoneNumber" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-sm-3 text-sm-right">输入密码</label>
                                <div class="col-sm-8">
                                    <input type="password" class="form-control" name="password" placeholder="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-sm-3 text-sm-right">确认密码</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group" style="display:inline;align-content: center">
                                ...
                                <div class="col-sm-10 ml-sm-auto" style="display:inline">
                                    <button type="submit" class="btn btn-primary" style="display:inline;">确认注册</button>
                                </div>
                                <div class="col-sm-10 ml-sm-auto" style="display:inline">
                                    <button form="toLogin" type="submit" class="btn btn-primary" style="display:inline;">返回</button>
                                </div>
                            </div>
                        </form>
                    </div>
